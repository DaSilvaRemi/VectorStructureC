...
void vector_v1_double_insert(p_s_vector_v1_double p_vector, size_t i, double v){
    ...
    if(p_vector->size + 1 >= p_vector->capacity){
        ...
        p_vector->tab = realloc(sizeof(double) * newCapacity);
...
void vector_v1_push_back(p_s_vector_v1_double p_vector){
    vector_v1_double_insert(p_vector, p_vector->size)
}
